...
# ------------------------------------------------------------------------------------------
# INJEÇÃO DE CSS - DEFINIÇÃO DAS CORES DA LOGO (AZUL E AMARELO ALARANJADO)
# ------------------------------------------------------------------------------------------
st.markdown("""
    <style>
    .stButton > button {
...
# ------------------------------------------------------------------------------------------
# PAINEL GERAL (DASHBOARD) - RETORNADO AO MODELO TABULAR COMPACTO ORIGINAL
# ------------------------------------------------------------------------------------------
    ...
    if st.session_state.visualizar_brinco:
        ...
        if not dados_rebanho:
            ...
            with tab_ativos:
                ...
                st.markdown("---")
                if ativos:
                    # Retorno da estrutura original em tabelas/colunas largas
